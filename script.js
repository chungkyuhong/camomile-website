...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.solution-card, .contact-item, .feature');
...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        // Simple validation
        if (!data.company || !data.name || !data.email || !data.solution) {
...
// Add loading animation to solution cards
